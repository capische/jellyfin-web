...
export const BLOCKER_SENTENCES = new Map<string, string>([
...
export const BLOCKER_SECTIONS = new Map<string, string>([
...
export const PAUSE_SENTENCES = new Map<string, string>([
...
export const PATH_SENTENCES = new Map<string, string>([
