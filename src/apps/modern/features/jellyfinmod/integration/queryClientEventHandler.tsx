...
/** Keeps JellyfinMod catalog surfaces current without changing upstream query ownership. */
const JellyfinModQueryClientEventHandler: FC = () => {
...
export default JellyfinModQueryClientEventHandler;
